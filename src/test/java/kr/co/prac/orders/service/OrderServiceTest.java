...
public class OrderServiceTest {
	...
	*/
	...
	public void create_order() {
		...
		List<OrderCreateRequest> list = List.of(createOrderCreateRequest(productNumber, 1));
		
		given(memberRepository.findById(memberId)).willReturn(Optional.of(member));
		given(ordersRepository.save(any(Orders.class))).willAnswer(invocation -> invocation.getArgument(0));
	...
	public void empty_request() {
		assertThrows(EmptyItemOrderException.class, ()-> orderService.createOrder(1L, null));
	}
